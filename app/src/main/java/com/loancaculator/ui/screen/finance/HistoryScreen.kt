...
fun FinanceHistoryScreen(
        ...
        LazyColumn(
            ...
            item {
                Card(
                    ...
                    Row(
                        Modifier.padding(5.dp).height(IntrinsicSize.Min),
    ...
    if (showDeleteDialog) {
        ...
        val deletedMessage = stringResource(R.string.history_deleted, count)
        AlertDialog(
            onDismissRequest = { showDeleteDialog = false },
            title = { Text(stringResource(R.string.delete_history_title)) },
            text = { Text(stringResource(R.string.delete_history_message, count)) },
            confirmButton = {
                TextButton(
                    onClick = {
